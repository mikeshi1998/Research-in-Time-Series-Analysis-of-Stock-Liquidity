...
for year in years:
        ...
        statement = "select date, cusip from crspq.dsf where date = '" + start_date + "'"
        ...
        for y, y_label in zip([l_year, ll_year, lll_year], ['l_year', 'll_year', 'lll_year']):
            for q in quarters_index[y]:
                statement = "select a.cusip, b.conm, b.tic, b.rdq, b.atq, b.dlttq, b.ltq, b.cheq, b.oibdpq, b.ppentq, b.piq, b.revtq, b.niq, b.cogsq, b.xoprq, b.xintq, b.oiadpq, b.dlcq from crspq.dsf a join comp.fundq b on b.cusip::varchar(8) = a.cusip where a.date = '" + start_date + "' and b.fyearq = " + str(y) + " and b.fqtr = " + str(q)
